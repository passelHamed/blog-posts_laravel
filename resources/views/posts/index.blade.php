    ...
    <div class="row">
        ...
        <aside class="col-md-4 blog-sidebar">
            <div class="p-4 mb-3 bg-light rounded">
                <h4>e-marketing principles</h4>
                <p>You can now buy your copy of the e-marketing principles book at a 30% discount, enter your e-mail address to receive a message with details</p>
